...
fn main() -> Result<()> {
    let input = fs::read_to_string("input/aoc2020/day15")?;
    println!("{}", count(&input, 2020 - 1));
    println!("{}", count(&input, 30000000 - 1));
    Ok(())
}

fn count(s: &str, n: usize) -> i64 {
